...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  agro: {
    title: 'Agro Monitor - Real-Time Agricultural Intelligence Dashboard',
    description: 'Real-time agricultural intelligence dashboard tracking crop markets, food security, weather impacts, commodity prices, and supply chain disruptions worldwide.',
    keywords: 'agriculture dashboard, crop monitoring, food security, commodity prices, wheat prices, corn futures, soybean markets, FAO, USDA, food supply chain, crop weather, drought monitor, locust watch, grain ports, agri news, farm markets',
    url: 'https://agro.worldmonitor.app/',
    siteName: 'Agro Monitor',
    shortName: 'AgroMonitor',
    subject: 'Agricultural Intelligence and Food Security Monitoring',
    classification: 'Agricultural Dashboard, Commodity Tracker, Food Security Intelligence',
    categories: ['news', 'business'],
    features: [
      'Agricultural commodity price tracking',
      'Crop stress zone mapping',
      'Food security intelligence',
      'Grain export port monitoring',
      'Crop fire damage tracking',
      'Desert locust watch zones',
      'Crop weather alerts',
      'FAO/USDA/WFP news integration',
      'Trade and export ban alerts',
      'Supply chain disruption monitoring',
      'Black Sea grain corridor tracking',
      'Agro exchange mapping',
    ],
  },
};
